...
<link rel="stylesheet" type="text/css" href="../../public/dist/css/speech-input.css">

<script src="../../public/dist/js/speech-input"></script>
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Ajout promotion</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method="POST" action="?controller=promotions&action=save">
                                        ...
                                        <label>Pourcentage</label>
                                            <input  type="number" class="speech-input" class="form-control"  id="pourcentage"  name="pourcentage" onchange="pourcent()">
                                            <p id="pr" style="display:none; color:red">this number should be greater than 0 and less than 100</p>
